 ...
 */
public class SMOreg extends AbstractClassifier implements WeightedInstancesHandler, AdditionalMeasureProducer,
		TechnicalInformationHandler
{
	public double[] getAttributeWeights()
	{
		double o[] = m_optimizer.getWeights();
	...
	{
		return m_optimizer.getAttributes();
	}
	...
	public String globalInfo()
	{
		return "SMOreg implements the support vector machine for regression. "
				...
				+ RegSMOImproved.class.getName().replaceAll(".*\\.", "") + ") is due to Shevade, Keerthi "
	...
	public String[] getOptions()
	{
		...
		result.add("-I");
		result.add("" + getRegOptimizer().getClass().getName() + " "
