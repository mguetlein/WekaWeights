 ...
 */
public class RandomForest extends AbstractClassifier implements OptionHandler, Randomizable, WeightedInstancesHandler,
		AdditionalMeasureProducer, TechnicalInformationHandler
{
	...
	{
		return ((RandomTree) m_bagger.getClassifier(0)).getAttributes();
	}
	...
	public String toString()
	{
		...
		if (m_bagger == null)
			...
			return "Random forest of " + m_numTrees + " trees, each constructed while considering " + m_KValue
